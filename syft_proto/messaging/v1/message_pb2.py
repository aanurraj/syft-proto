...
_OBJECTMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='plan', full_name='syft_proto.messaging.v1.ObjectMessage.plan', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_OBJECTMESSAGE.fields_by_name['plan'].message_type = syft__proto_dot_execution_dot_v1_dot_plan__pb2._PLAN
_OBJECTMESSAGE.oneofs_by_name['object'].fields.append(
  _OBJECTMESSAGE.fields_by_name['tensor'])
_OBJECTMESSAGE.fields_by_name['tensor'].containing_oneof = _OBJECTMESSAGE.oneofs_by_name['object']
_OBJECTMESSAGE.oneofs_by_name['object'].fields.append(
  _OBJECTMESSAGE.fields_by_name['plan'])
_OBJECTMESSAGE.fields_by_name['plan'].containing_oneof = _OBJECTMESSAGE.oneofs_by_name['object']
